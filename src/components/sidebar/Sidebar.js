    ...
    <Grid container>
      ...
      <Grid item xs={6}>
        ...
        <Typography style={{ marginBottom: 20 }} variant="body1">
          ...
          Miami University pursuing a B.S. and M.S. in Computer Science, a B.S.
          in Data Science and Statistics, and a minor in Mathematics. I interned
          ...
          . This semester, I am building a simulation model and platform for the
          CDC, continuing my simulation research, starting two machine learning
          and computer vision projects, and working on my master's thesis
          proposal. After graduation, I plan on pursuing a Ph.D. in Computer
          Science with a research focus in simulation or machine learning.
        </Typography>
        <Button
